...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid w-full gap-2 px-0 select-none relative"
...
const MagicBento = ({
  ...
  const useFeaturedLayout = cards.length > 4;
  ...
  return (
    <>
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            .card-responsive.layout-featured .card:nth-child(3) {
              grid-column: span 2;
              grid-row: span 2;
            }

            .card-responsive.layout-featured .card:nth-child(4) {
              grid-column: 1 / span 2;
              grid-row: 2 / span 2;
            }

            .card-responsive.layout-featured .card:nth-child(6) {
              grid-column: 4;
              grid-row: 3;
            }
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className={`card-responsive grid gap-2 ${useFeaturedLayout ? 'layout-featured' : ''}`}>
              ...
              return (
                ...
                >
                  <div className="card__content flex h-full flex-col items-center justify-center text-center relative text-black">
                    ...
                    <p
                      className={`card__description text-base leading-7 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}
                    >
                      {card.description}
                    </p>
                  </div>
            ...
            return (
              ...
              >
                <div className="card__content flex h-full flex-col items-center justify-center text-center relative text-black">
                  ...
                  <p className={`card__description text-base leading-7 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                </div>
              </div>
